...
function fabricate(bakes, fabricator, snap, body, cb) {
    ...
    if (!child) {
      ...
      if (fabricator.platform === 'linux' && fabricator.arch !== 'x64') {
        const qemus = {
        ...
        children[key] = (0, child_process_1.spawn)(qemus[fabricator.arch], ['-L', tools[fabricator.arch], cmd].concat(activeBakes.concat('-e', script)), {
