...
async function dependencies(options) {
  ...
  await remoteResource({ id: 'linux-armv7l', type: 'node', repo: 'ih-v5', tag: 'v0.0.0', asset: 'node-linux-armv7l.tar.gz', zip: 'tgz' });
  ...
  await remoteResource({ id: 'node_modules', type: 'npm', repo: 'ih-v5', tag: 'v0.0.0', asset: 'node_modules.zip' });
